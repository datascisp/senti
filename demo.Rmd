...
# Data acquisition
Tweets fetched from 20 to 30 twitter handles of banks across US and UK markets. The number of tweets used for training set would be around 40,000.  The task of data extraction will be performed on IIP.
